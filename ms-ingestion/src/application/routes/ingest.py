...
async def ingest_document(
    ...
    coleccion: str   = Query(default="curriculum_pdc", description="Colección ChromaDB"),
    admin_id: str | None = Query(default=None, description="UUID del admin que sube el archivo"),
):
    """
